...
describe('Testing Easy Paginator:', () => {
  test('Creating a paginator with the default parameters creates the correct UI and callback data.', () => {
    const result = getModalObject(EasyPaginator<Human>({
      page: 1,
      perPage: 5,
      items: humans,
          ...
          elements: [
            {
              ...
              action_id: '{"totalItems":20,"perPage":5,"totalPages":4,"offset":15,"page":4}',
              type: 'button',
            },
            {
              text: {
              ...
              action_id: '{"totalItems":20,"perPage":5,"totalPages":4,"offset":5,"page":2}',
              type: 'button',
            },
          ],
          type: 'actions',
  ...
  test('Creating a paginator somewhere in the middle parameters creates the correct UI and callback data.', () => {
    const result = getModalObject(EasyPaginator({
      items: humans,
      page: 2,
      perPage: 5,
      actionId: (params) => JSON.stringify(params),
          ...
          elements: [
            {
              ...
              action_id: '{"totalItems":20,"perPage":5,"totalPages":4,"offset":0,"page":1}',
              type: 'button',
            },
            {
              text: {
              ...
              action_id: '{"totalItems":20,"perPage":5,"totalPages":4,"offset":10,"page":3}',
              type: 'button',
            },
          ],
          type: 'actions',
